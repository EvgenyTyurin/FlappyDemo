...
import tiurin.evgeny.sprites.Bird;
import tiurin.evgeny.sprites.Tube;
...
public class PlayState extends State {
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.begin();
        sb.draw(bg, camera.position.x - camera.viewportWidth / 2, 0 - GROUND_Y_OFFSET,
                FlappyDemo.WIDTH / 2, FlappyDemo.HEIGHT / 2);
